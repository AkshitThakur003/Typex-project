...
export default function Button({ children, className = '', glow = 'emerald', onClick, ...props }) {
  ...
  return (
    <m.button
      ...
      whileTap={{ scale: 0.98 }}
      className={`relative overflow-hidden inline-flex items-center justify-center rounded-lg px-4 py-2 font-semibold transition touch-target min-h-[44px] ${glowClass} ${className}`}
    >
